...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        vbox.getChildren().addAll(titleLabel, addDrugButton, viewDrugsButton, addSupplierButton, viewSuppliersButton, viewPurchaseHistoryButton, addCustomerButton, viewCustomersButton);
